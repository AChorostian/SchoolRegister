...
SimpleCov.start do
    ...
    add_filter '/lib/Stats.rb'
    add_filter '/lib/List.rb'
    add_filter '/lib/Menu.rb'
    add_filter '/lib/Single.rb'
    add_filter '/spec/' # for rspec
    add_filter '/test/' # for test
end
RSpec.configure do |config|
    # rspec-expectations config goes here. You can use an alternate
    # assertion/expectation library such as wrong or the stdlib/test
    ...
    # with RSpec, but feel free to customize to your heart's content. =begin
     ...
     # as the one that triggered the failure. Kernel.srand config.seed =end
end
